...
>*Note:
>This solution is based in this one. However, both solutions will probably follow different lifecycles since .Net Core 3.x is the technical path to >follow and it includes IoT related capabilities.*
